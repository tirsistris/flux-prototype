// icons.jsx — Flux token coins + UI glyphs. Exports to window.
// Coin marks are abstract/original (letters + simple geometry), not exact brand logos.
...
function Coin({ id, size = 44, glowScale = 1, style = {} }) {
...
const Ico = {
  ...
  tabMarkets: (c = '#fff', w = 24, fill = false) => (
  ...
  tabWallet: (c = '#fff', w = 24, fill = false) => (
  ...
  tabTrade: (c = '#fff', w = 24, fill = false) => (
  ...
  tabProfile: (c = '#fff', w = 24, fill = false) => (
...
Object.assign(window, { COINS, Coin, Ico });
