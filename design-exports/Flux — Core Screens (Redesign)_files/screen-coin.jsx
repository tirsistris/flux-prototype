// screen-coin.jsx — Flux coin detail (opens on tapping a coin). Exports ScreenCoin.
const { PhoneFrame, AreaChart, CoinAvatar, Ico, FLUX, eur, pct, signEur, fmtNum, chColor, BalAmt } = window;
...
function ScreenCoin() {
  ...
  const footer = (
    <div className="fl-ctabar">
      <button className="fl-cta-buy">{Ico.receive('#fff', 19)}Buy</button>
