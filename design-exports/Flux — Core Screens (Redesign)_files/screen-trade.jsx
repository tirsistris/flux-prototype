// screen-trade.jsx — Flux Trade, restyled. Exports ScreenTrade.
const { PhoneFrame, AreaChart, CoinAvatar, Ico, FLUX, eur, pct, signEur, fmtNum, chColor, ACCENT, BalAmt } = window;
...
function ScreenTrade() {
  ...
  const payAmt = 0.1, payCoin = FLUX.coins.btc;
  ...
  return (
    <PhoneFrame active="trade">
      ...
      <div style={{ marginTop: 16 }}>
        <AreaChart vals={FLUX.curve} w={342} h={118} label={eur(103455.44)} id="trade" />
      </div>

      <div className="fl-sec-head" style={{ marginTop: 14 }}><span className="fl-sec-title">Convert</span></div>
